...
<html lang="fr">
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="/assets/templates/ban/css/plugins.css">
        <link type="text/css" rel="stylesheet" href="/assets/templates/ban/css/style.css">
        <link rel="shortcut icon" href="/assets/templates/images/ban/favicon.ico">
        <link type="text/plain" rel="author" href="/assets/templates/ban/humans.txt">
    </head>
    <body>
        <div id="main">
            <div class="cs-wrap">
        ...
        <script src="/assets/templates/ban/js/jquery.min.js"></script>
        <script src="/assets/templates/ban/js/scripts.js"></script>
    </body>
</html>